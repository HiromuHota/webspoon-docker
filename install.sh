...
wget https://github.com/HiromuHota/big-data-plugin/releases/download/webspoon%2F$version/pentaho-big-data-impl-shim-hive-$dist.jar -O ${CATALINA_HOME}/system/karaf/system/pentaho/pentaho-big-data-impl-shim-hive/$dist/pentaho-big-data-impl-shim-hive-$dist.jar
